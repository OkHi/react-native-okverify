  ...
  return new Promise(async (resolve, reject) => {
    ...
    try {
      if (requestServices) {
        ...
        await (0, _reactNativeCore.requestLocationPermission)();
      }

      Promise.all([(0, _reactNativeCore.isGooglePlayServicesAvailable)(), (0, _reactNativeCore.isLocationPermissionGranted)(), (0, _reactNativeCore.isLocationServicesEnabled)()]).then(result => {

...
import { OkHiException, isGooglePlayServicesAvailable, isLocationPermissionGranted, requestEnableGooglePlayServices, requestEnableLocationServices, requestBackgroundLocationPermission, isBackgroundLocationPermissionGranted } from '@okhi/react-native-core';
...
export const canStartVerification = configuration => {
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      Promise.all([isGooglePlayServicesAvailable(), isLocationPermissionGranted(), isBackgroundLocationPermissionGranted()]).then(result => {
